...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Edecan.descripcion'
        db.alter_column(u'administrador_edecan', 'descripcion', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Edecan.nombre'
        db.alter_column(u'administrador_edecan', 'nombre', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))

        # Changing field 'Evento.lugar'
        db.alter_column(u'administrador_evento', 'lugar', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))

        # Changing field 'Evento.servicio'
        db.alter_column(u'administrador_evento', 'servicio', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Edecan.descripcion'
        db.alter_column(u'administrador_edecan', 'descripcion', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Edecan.nombre'
        db.alter_column(u'administrador_edecan', 'nombre', self.gf('django.db.models.fields.CharField')(default='', max_length=60))

        # Changing field 'Evento.lugar'
        db.alter_column(u'administrador_evento', 'lugar', self.gf('django.db.models.fields.CharField')(default='', max_length=60))

        # Changing field 'Evento.servicio'
        db.alter_column(u'administrador_evento', 'servicio', self.gf('django.db.models.fields.CharField')(default='', max_length=100))
    ...
    models = {
        ...
        u'administrador.email': {
            ...
            'fecha': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2019, 9, 23, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
